...
<body>
<div id="head">
		<img src="../images/faxweb.gif" class="logo" alt="Faxweb beta 2.0" />
...
<?
		...
		echo "<li>|</li><li><a href='../faxweb.html'>Faxweb</a></li><li><a href='../faxweb.php?faxweb=userLogoff'>Logout</a></li>";
		?>
